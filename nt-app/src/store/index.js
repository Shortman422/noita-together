...
const ipcPlugin = (ipc) => {
    return (store) => {
        ...
        */
        ...
        ipc.on("sRoomModFlagsUpdateFailed", (event, data) => {
            store.commit("sRoomModFlagsUpdateFailed", data)
        })
...
export default new Vuex.Store({
    ...
    mutations: {
        ...
        sRoomModFlagsUpdateFailed: (state, payload) => {
            logger.debug(`sRoomModFlagsUpdateFailed: ${JSON.stringify(payload)}`)
        },
        ...
        resetRoom: (state) => {
            ...
            state.roomFlags = []
            state.modFlags = new Map()
            state.presetModFlags = new Map()
        },
